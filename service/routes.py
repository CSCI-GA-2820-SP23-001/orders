...
from flask import url_for, jsonify, request, make_response, abort, Blueprint, current_app
...
def create_order():
    ...
    """
    current_app.logger.info("Request to create an Order")
...
def get_orders(order_id):
    ...
    """
    current_app.logger.info("Request for Order with id: %s", order_id)
...
def list_orders():
    ...
    current_app.logger.info("Request for Order list")
    orders = []
...
def update_orders(order_id):
    ...
    """
    current_app.logger.info("Request to update order with id: %s", order_id)
    check_content_type("application/json")
...
def delete_orders(order_id):
    ...
    """
    current_app.logger.info("Request to delete an order with id: %s", order_id)
...
def list_items(order_id):
    ...
    current_app.logger.info("Request for all Items for an Order with id: %s", order_id)
