...
[![Build Status](https://github.com/CSCI-GA-2820-SP23-001/orders/actions/workflows/ci.yml/badge.svg)](https://github.com/CSCI-GA-2820-SP23-001/orders/actions)
...
```bash
git clone https://github.com/CSCI-GA-2820-SP23-001/orders.git
cd orders
```
